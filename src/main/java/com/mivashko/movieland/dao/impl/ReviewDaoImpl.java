...
public class ReviewDaoImpl implements ReviewDao {
    ...
    private final String QUERY_GET_REVIEW_BY_MOVIE_ID = "SELECT t1.id, t1.movie_id, t1.user_id,   t1.text,   t2.first_name," +
        "t2.last_name  FROM review t1  join user t2  on t1.user_id = t2.id WHERE t1.movie_id = :movie_id  ORDER BY RAND()   LIMIT 2";
    ...
    public List<Review> getByMovieId(int movieId) {
        ...
        try {
            ...
            reviewList = daoService.executeNamedQuery (QUERY_GET_REVIEW_BY_MOVIE_ID, parameter, reviewRowMapper );
        } catch (Exception e) {
            e.printStackTrace();
        }
